...
interface IERC20{
    ...
    // Enviar tokens de una direccion a otra
    function transferTo(address sender, address receiver, uint256 amount) external returns(bool);
...
contract Token is IERC20 {
    ...
    function transferTo(address sender, address receiver, uint256 amount) public override returns(bool){
